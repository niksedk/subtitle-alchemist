...
public sealed class WhisperAdvancedHistoryPopup : Popup
{
    public WhisperAdvancedHistoryPopup(WhisperAdvancedHistoryPopupModel vm)
    {
        vm.Popup = this;
        BindingContext = vm;
        ...
        {
            Text = "Choose parameter from history",
