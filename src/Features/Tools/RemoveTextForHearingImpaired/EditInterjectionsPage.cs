...
public class EditInterjectionsPage : ContentPage
{
    ...
    private Border MakeCollectionView(EditInterjectionsPageModel vm)
    {
    ...
    private static ScrollView MakeOptions(EditInterjectionsPageModel vm)
    {
        var grid = new Grid
        {
            HorizontalOptions = LayoutOptions.Fill,
    ...
    private static Border MakeInterjections(EditInterjectionsPageModel vm)
    {
        var grid = new Grid
        {
            HorizontalOptions = LayoutOptions.Fill,
    ...
    private static Border MakeRemoveIfTextContains(EditInterjectionsPageModel vm)
    {
        var grid = new Grid
        {
            HorizontalOptions = LayoutOptions.Fill,
    ...
    private static Border MakeRemoveIfOnlyMusicSymbols(EditInterjectionsPageModel vm)
    {
        var grid = new Grid
        {
            HorizontalOptions = LayoutOptions.Fill,
    ...
    private static Border MakeViewRemoveBeforeColon(EditInterjectionsPageModel vm)
    {
        var grid = new Grid
        {
            HorizontalOptions = LayoutOptions.Fill,
    ...
    private static Border MakeGridRemoveBetween(EditInterjectionsPageModel vm)
    {
